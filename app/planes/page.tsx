...
const MATRIX: MatrixRow[] = [
  ...
  { feat: 'Reportes PDF mensuales', sub: 'research cuantitativo',
    free: ['part', '1 reporte de muestra'],
    pro:  ['pro',  'Mensual + hemeroteca completa'] },
...
const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Reportes PDF mensuales + hemeroteca',
