...
export interface StakingOption {
  ...
  plataforma: string; risk: RiskLevel; url: string
}
export const STAKING: StakingOption[] = [
  { activo: 'ETH',   apyMin: 3.0, apyMax: 4.2,  lockup: 'Flexible', plataforma: 'Lido / Rocket Pool',   risk: 'Bajo',   url: 'https://lido.fi' },
  { activo: 'BNB',   apyMin: 5.0, apyMax: 8.0,  lockup: '7–30 días',plataforma: 'Binance / Venus',       risk: 'Bajo',   url: 'https://www.binance.com/es/earn' },
  { activo: 'SOL',   apyMin: 6.0, apyMax: 7.5,  lockup: 'Flexible', plataforma: 'Marinade / Jito',       risk: 'Bajo',   url: 'https://marinade.finance' },
  { activo: 'CAKE',  apyMin: 10,  apyMax: 25,   lockup: 'Variable', plataforma: 'PancakeSwap',            risk: 'Medio',  url: 'https://pancakeswap.finance' },
...
export interface DefiOption {
  ...
  audited: boolean; chain: string; tipo: string; risk: RiskLevel; url: string
}
export const DEFI_EARN: DefiOption[] = [
  { protocolo: 'Aave V3',   activo: 'USDC',   apySupply: 4.8,  tvlM: 2100, audited: true,  chain: 'Multi',  tipo: 'Lending', risk: 'Bajo',   url: 'https://app.aave.com' },
  { protocolo: 'Venus',     activo: 'BNB',    apySupply: 6.2,  tvlM: 800,  audited: true,  chain: 'BSC',    tipo: 'Lending', risk: 'Bajo',   url: 'https://venus.io' },
  { protocolo: 'Compound',  activo: 'USDT',   apySupply: 3.9,  tvlM: 1500, audited: true,  chain: 'ETH',    tipo: 'Lending', risk: 'Bajo',   url: 'https://compound.finance' },
  { protocolo: 'Beefy',     activo: 'BNB-LP', apySupply: 18.4, tvlM: 120,  audited: true,  chain: 'BSC',    tipo: 'Vault',   risk: 'Medio',  url: 'https://beefy.finance' },
  { protocolo: 'Yearn V3',  activo: 'USDC',   apySupply: 7.1,  tvlM: 450,  audited: true,  chain: 'ETH',    tipo: 'Vault',   risk: 'Bajo',   url: 'https://yearn.fi' },
...
export interface LpOption {
  par: string; dex: string; feeApr: number; farmApr: number; risk: RiskLevel; url: string
}
export const LP_POOLS: LpOption[] = [
  { par: 'BNB/USDT',  dex: 'PancakeSwap', feeApr: 8.2,  farmApr: 6.4,  risk: 'Medio', url: 'https://pancakeswap.finance' },
  { par: 'ETH/USDC',  dex: 'Uniswap V3',  feeApr: 12.1, farmApr: 0,    risk: 'Medio', url: 'https://app.uniswap.org' },
  { par: 'CAKE/BNB',  dex: 'PancakeSwap', feeApr: 15.3, farmApr: 22.1, risk: 'Alto',  url: 'https://pancakeswap.finance' },
  { par: 'WBTC/ETH',  dex: 'Uniswap V3',  feeApr: 9.8,  farmApr: 0,    risk: 'Medio', url: 'https://app.uniswap.org' },
  { par: 'USDT/USDC', dex: 'PancakeSwap', feeApr: 4.1,  farmApr: 2.8,  risk: 'Bajo',  url: 'https://pancakeswap.finance' },
  { par: 'BTC/USDC',  dex: 'Uniswap V3',  feeApr: 11.4, farmApr: 0,    risk: 'Medio', url: 'https://app.uniswap.org' },
]

export interface DivOption {
  token: string; protocolo: string; tipo: string; yieldMin: number; yieldMax: number; freq: string; risk: RiskLevel; url: string
}
export const DIV_CRYPTO: DivOption[] = [
  { token: 'GMX',  protocolo: 'GMX.io',        tipo: 'ETH/AVAX fees', yieldMin: 8,  yieldMax: 15, freq: 'Tiempo real', risk: 'Medio', url: 'https://gmx.io' },
  ...
  { token: 'VELO', protocolo: 'Velodrome',      tipo: 'Fees + bribes', yieldMin: 15, yieldMax: 40, freq: 'Semanal',     risk: 'Alto',  url: 'https://velodrome.finance' },
]
export const DIV_TRADFI: DivOption[] = [
  { token: 'VYM',  protocolo: 'Vanguard ETF',  tipo: 'Dividendo',     yieldMin: 2.8, yieldMax: 3.5, freq: 'Trimestral', risk: 'Muy bajo', url: 'https://finance.yahoo.com/quote/VYM' },
  { token: 'SCHD', protocolo: 'Schwab ETF',    tipo: 'Dividendo',     yieldMin: 3.2, yieldMax: 4.0, freq: 'Trimestral', risk: 'Muy bajo', url: 'https://finance.yahoo.com/quote/SCHD' },
